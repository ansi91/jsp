...
<input type="hidden" id="bs_seq" name="bs_seq" value="<%=rMap.get("BS_SEQ") %>">
...
<table align="center" width="650px" height="280px">
	<tr>
		...
		<td width="580px">
			<input id="ubm_title"  name="bm_title" class="easyui-textbox" value="<%=rbm_title%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="580px">
			<input id="ubm_content" multiline="true"  name="bm_content" class="easyui-textbox" style="width:100%;height:100px">
		</td>
	</tr>	
	<tr>
